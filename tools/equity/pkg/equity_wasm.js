 ...
 * @returns {any}
 */
export function analyze(range, board) {
 ...
 * @returns {any}
 */
export function equity_mc(range1, range2, board, num_sims) {
    const ptr0 = passStringToWasm0(range1, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(range2, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passStringToWasm0(board, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.equity_mc(ptr0, len0, ptr1, len1, ptr2, len2, num_sims);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
